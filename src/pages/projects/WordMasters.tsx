...
const WordMasters = () => {
  ...
  const overviewText = (
    <p>
      The scope of the Word Masters project was to create a clone of the popular
      Wordle game using HTML, CSS, and Javascript. The project built on previous
      course work and introduced AJAX requests, JSON, and async/await functions.
      <br />
      <br />
      The project was the final project of the Frontend Masters, &quot;Complete
      Intro to Web Development v3&quot; course and represents the combined use
